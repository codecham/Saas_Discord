...
/**
 * Routes UIKit avec lazy loading des composants
 * ✅ Chaque composant est chargé dynamiquement à la navigation
 */
export default [
    {
        path: 'DashboardDemo',
        data: { breadcrumb: 'Home' },
        loadComponent: () => import('./dashboarddemo').then(m => m.DemoDashboardComponentDemo)
    },
    {
        path: 'button',
        data: { breadcrumb: 'Button' },
        loadComponent: () => import('./buttondemo').then(m => m.ButtonDemo)
    },
    {
        path: 'charts',
